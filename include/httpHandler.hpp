...
logpp::Logger HttpHandler::logger_ = logpp::Logger("HttpHandler");
std::map<std::string, std::chrono::system_clock::time_point> HttpHandler::hashTimestamps_;
std::vector<std::string> HttpHandler::need_auth_url_ = {
    "/modify_config",
    "/modify_passwd",
    "/get_config",
};
